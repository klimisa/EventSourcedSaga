...
public class CashierSaga
{
    ...
    public record Input
    {
        ...
        public record PaymentReceived
            (Guid OrderId, Guid CorrelationId, PaymentType PaymentType, decimal Amount) : Input;
    }
    ...
    public record Output
    {
        ...
        public record PaymentComplete
            (Guid OrderId, Guid CorrelationId, PaymentType PaymentType, decimal Amount) : Output;
    }
